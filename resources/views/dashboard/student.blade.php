    ...
    <div class="w-full block mt-8 bg-white">
        <div class="flex flex-wrap sm:flex-no-wrap justify-between">
            ...
            <div class="w-full sm:w-1/2 mr-2 mb-6">
                <div class="flex items-center bg-gray-600">
                    ...
                    <div class="w-1/3 text-left text-white py-2 px-4 font-semibold">Unit</div>
                    <div class="w-1/3 text-right text-white py-2 px-4 font-semibold">Lecturers</div>
                </div>
        ...
        <div class="w-full px-0 md:px-6 py-4">
            ...
            <div class="flex items-center bg-gray-600">
                ...
                <div class="w-1/4 text-left text-white py-2 px-4 font-semibold">Lecturers</div>
